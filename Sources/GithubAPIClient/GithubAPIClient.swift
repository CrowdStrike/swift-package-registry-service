...
public struct GithubAPIClient: Sendable {
    ...
    public var repositoryListReleases: @Sendable (RepositoryListReleases.Input) async throws -> RepositoryListReleases.Output = { _ in
        reportIssue("\(Self.self).repositoryListReleases not implemented")
        return .mock
    }

...
///
/// The [swift-package-manager](https://github.com/swiftlang/swift-package-manager) project
/// gets this `Version` file from the [swift-tools-support-core](https://github.com/swiftlang/swift-tools-support-core/tree/main)
/// project. Normally, we could just add that package as a dependency of this project. However,
/// that project has this in their [README.md](https://github.com/swiftlang/swift-tools-support-core/blob/main/README.md):
///
/// ```
/// As this package with time has become a collection of unrelated utilities, that made it much harder
/// to version. Primary users of TSC such as SwiftPM and Swift Driver came up with specialized alternatives
/// to APIs provided in TSC. Moving forward, we don't recommend adding TSC as a dependency to your project.
/// More and more types and functions here will be deprecated, with minimal modifications to ease the migration
/// off TSC.
/// ```
///
/// So therefore, we lift this file from [here](https://github.com/swiftlang/swift-tools-support-core/blob/main/Sources/TSCUtility/Version.swift),
